...
async function findOwnedVehicle(vehicleId, userId) {
...
app.get("/api/vehicles/:vehicleId/maintenance", authenticateToken, async (req, res) => {
    try {
...
app.post("/api/vehicles/:vehicleId/maintenance", authenticateToken, async (req, res) => {
    try {
        const vehicleId = req.params.vehicleId;
        const ownedVehicle = await findOwnedVehicle(vehicleId, req.userId);
        if (!ownedVehicle) {
...
app.get("/api/dashboard", authenticateToken, async (req, res) => {
    try {
        ...
        const [totalVehicles, totalMaintenance, maintenanceCosts] = await Promise.all([
...
app.get("/api/vehicles/:vehicleId/fuel", authenticateToken, async (req, res) => {
    try {
        const vehicleId = req.params.vehicleId;
        const ownedVehicle = await findOwnedVehicle(vehicleId, req.userId);
        if (!ownedVehicle) {
...
app.post("/api/vehicles/:vehicleId/fuel", authenticateToken, async (req, res) => {
    try {
        const vehicleId = req.params.vehicleId;
        const ownedVehicle = await findOwnedVehicle(vehicleId, req.userId);
        if (!ownedVehicle) {
...
app.patch("/api/fuel/:id", authenticateToken, async (req, res) => {
    try {
        const id = req.params.id;
